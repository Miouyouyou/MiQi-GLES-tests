...
VIDEO_CARDS="amdgpu exynos freedreno intel nouveau omap radeon rockchip tegra vc4 vivante vmware"
...
src_prepare() {
	...
	git apply "${FILESDIR}"/${PN}-2.4.73-rockchip.patch
	xorg-2_src_prepare
}
...
src_configure() {
	XORG_CONFIGURE_OPTIONS=(
		...
		$(use_enable video_cards_rockchip rockhip-experimental-api)
		$(use_enable libkms)
